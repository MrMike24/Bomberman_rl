    ...
    for (xb, yb), t in bombs:
        ...
        for dx, dy in [(0, -1), (0, 1), (-1, 0), (1, 0)]:
            for dist in range(1, bomb_power + 1):
                ...
                if field[nx, ny] == 1:   # Destructible crate stops blast propagation
                    break
...
def count_escape_routes(game_state, bomb_pos=None):
    """
    Counts the number of distinct safe tiles reachable within 3 steps after dropping a bomb.
    """
    field = game_state['field']
    explosion_map = game_state['explosion_map']
    bombs = list(game_state['bombs'])
